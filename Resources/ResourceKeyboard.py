    ...
    def moveFloatRight(self):
        ...
        if(self.currentFocus != 9 and self.currentFocus != 10 and self.currentFocus != 11):
            ...
            if(self.prevFloat == 0):
                ...
                self.floatButtons[self.buttons[self.currentFocus]][self.currentFloat-1].setStyleSheet("background-color: blue")
            
            elif(self.currentFloat == 0):
                self.buttons[self.currentFocus].setStyleSheet("background-color: blue")
                self.floatButtons[self.buttons[self.currentFocus]][self.prevFloat-1].setStyleSheet("background-color: black")
